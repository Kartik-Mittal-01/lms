            ...
            {enrolledCourses.map((course , index) => (
              <tr key={index} className='border-b border-gray-500/20'>
                ...
                <td className='px-4 py-3 max-sm:text-right'>
                  <button 
                  className={`${
                      progressArray[index].lectureCompleted === progressArray[index].totalLectures ? "w-30" : "w-30"
                    } sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white text-center rounded-full`}
